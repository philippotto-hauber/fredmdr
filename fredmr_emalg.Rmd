---
title: "fredmdr - EM algorithm"
author: "Philipp Hauber"
date: "1 11 2019"
output: html_document
---

# Load transformed dataset and prepare for estimation
...
**f_pca**: principal component analysis
...
**f_baing**: determines number of factors according the criteria in Bai and Ng (2002)
...
## Set-up
```{r}
Nr_max <- 10 # maximum number of factors
ic <- "PC_p1" # information crtierion (allowed are: PC_p1, PC_p2, PC_p3, none)
Niter <- 50 # maximum number of iterations
iter <- 0 # set iteration counter to 0
err <- 999 # set initial error to a large value
```
